...
<div data-theme={config.theme} class="min-h-screen flex flex-col">
  <header class="border-b border-surface-200-800 px-4 py-3 flex items-center gap-4">
    <a href="{base}/" class="font-bold text-lg tracking-tight hover:opacity-80 transition-opacity">
      {config.title}
    </a>
